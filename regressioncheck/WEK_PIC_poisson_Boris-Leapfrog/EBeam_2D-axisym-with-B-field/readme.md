...
* 2D axisymmetric with === axial direction in x === and 3D with additional parameter `PIC-variableExternalFieldSymAxis = 1`
...
* Comparing the interpolated magnetic field in x- and y-direction, minor deviations in 3D since the extent of the domain in z is not zero
