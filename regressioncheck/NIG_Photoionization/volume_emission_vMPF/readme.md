...
* comparison of the number of emitted electrons with an analytical solution
...
* Different MPFs for the electron species trigger different MPFs for the products, but the density should remain the same
